...
import com.kaijin.mffs.ContainerReactorCooler;
import com.kaijin.mffs.TileEntityReaktorCooler;
...
public class GuiReaktorCooler extends GuiContainer {
	...
	protected void drawGuiContainerBackgroundLayer(float f, int i, int j) {
		...
		int textur = mc.renderEngine.getTexture("/com/kaijin/mffs/textures/reaktorcooler.png");
